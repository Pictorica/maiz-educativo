/**
 * Quiz Audio Manager (Browser-compatible version)
 * Handles background music and sound effects for the quiz
 * No module imports - works directly in browser with <script> tag
 */
...
// Also expose as window.QuizAudio for easier access
