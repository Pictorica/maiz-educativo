/**
 * Quiz Audio Manager for Maiz Educativo
...
export async function startBackgroundMusic() {
  ...
  try {
    ...
    console.warn('⚠️ Autoplay was prevented. User interaction required.');
    console.warn('Background music will start after user clicks/taps.');
